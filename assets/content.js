...
var CONTENT = {
  ...
  nav: [
    { id: "education", label: { en: "Education", ko: "교육" },
      ...
      subs: [
        ...
        { id: "edu-schools", label: { en: "School directory", ko: "학교 목록" } },
  ...
  education: {
    ...
    /* School directory — every school named in this guide, filterable.
       Fees/waitlists come from the researched content pack; "—" means not researched. */
    schools: {
      title: { en: "School directory", ko: "학교 디렉토리" },
      intro: {
        en: "Every school named in this guide, in one filterable table. Fees are the researched figures or tier bands — always confirm current numbers with the school.",
        ko: "이 가이드에 등장하는 학교를 한 표에 모았어요. 필터로 추려 보세요. 학비는 조사된 수치나 티어 범위예요 — 최신 금액은 반드시 학교에 확인하세요."
      },
      all: { en: "All", ko: "전체" },
      ...
      cols: {
        ...
        system: { en: "System", ko: "학제" },
        fees: { en: "Fees", ko: "학비" },
        waitlist: { en: "Waitlist", ko: "대기" },
        location: { en: "Location", ko: "위치" }
      },
      rows: [
        { name: "PCF Sparkletots", stage: "pre", type: "local", system: "local",
        ...
        { name: { en: "Local MOE schools", ko: "로컬 MOE 학교" }, stage: "pri", type: "local", system: "local",
        ...
        { name: "Singapore American School (SAS)", stage: "pri", type: "intl", system: "american",
          fees: { en: "S$38–60k/yr (Tier 1 band)", ko: "연 S$38–60k (Tier 1 범위)" },
          waitlist: { en: "Multi-year, selective", ko: "수년 대기, 선발형" },
          location: "Woodlands" },
        { name: "Tanglin Trust", stage: "pri", type: "intl", system: "british",
          fees: { en: "Y1 S$45,375 (2026/27)", ko: "Y1 S$45,375 (2026/27)" },
          waitlist: { en: "Multi-year", ko: "수년 대기" },
          location: "One-North" },
        { name: { en: "UWCSEA (Dover & Tampines)", ko: "UWCSEA (Dover · Tampines)" }, stage: "pri", type: "intl", system: "ib",
        ...
        { name: "Dulwich College", stage: "pri", type: "intl", system: "british",
          fees: { en: "~S$35–38k/yr early years", ko: "유아부 연 약 S$35–38k" },
          waitlist: { en: "Multi-year, selective", ko: "수년 대기, 선발형" },
          location: "Bukit Batok" },
        { name: "SJII (St Joseph's Institution International)", stage: "pri", type: "intl", system: "ib",
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Selective; 50% local cohort", ko: "선발형; 학생 50%가 로컬" },
          location: "Thomson" },
        { name: "NLCS Singapore", stage: "pri", type: "intl", system: "british",
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Selective", ko: "선발형" },
          location: { en: "Depot Road", ko: "Depot Road" } },
        { name: "Canadian International School (CIS)", stage: "pri", type: "intl", system: "ib",
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Varies; strong EAL", ko: "학교별 상이; EAL 강함" },
          location: "Lakeside" },
        { name: "Stamford American (SAIS)", stage: "pri", type: "intl", system: "american",
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Rolling admissions", ko: "수시 입학" },
          location: "Woodleigh" },
        { name: "Australian International School (AIS)", stage: "pri", type: "intl", system: "other",
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Varies", ko: "학교별 상이" },
          location: "Serangoon" },
        { name: "Dover Court (Nord Anglia)", stage: "pri", type: "intl", system: "british",
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate; strong EAL", ko: "보통; EAL 강함" },
          location: "Dover" },
        { name: "GESS (German European School)", stage: "pri", type: "intl", system: "other",
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: { en: "Dairy Farm (Bukit Timah)", ko: "Dairy Farm (Bukit Timah)" } },
        { name: "Nexus International", stage: "pri", type: "intl", system: "ib",
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate; strong EAL", ko: "보통; EAL 강함" },
          location: "Aljunied" },
        { name: "Overseas Family School (OFS)", stage: "pri", type: "intl", system: "ib",
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: "Pasir Ris" },
        { name: "Chatsworth International", stage: "pri", type: "intl", system: "ib",
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: "Bukit Timah" },
        { name: "One World International (OWIS)", stage: "pri", type: "intl", system: "ib",
        ...
        { name: "Invictus International", stage: "pri", type: "intl", system: "other", systemVerify: true,
          fees: { en: "S$15–28k/yr (Tier 3 band)", ko: "연 S$15–28k (Tier 3 범위)" },
          waitlist: { en: "Direct entry", ko: "바로 입학" },
          location: { en: "Multiple campuses", ko: "여러 캠퍼스" } },
        { name: "Middleton (by EtonHouse)", stage: "pri", type: "intl", system: "other", systemVerify: true,
          fees: { en: "S$15–28k/yr (Tier 3 band)", ko: "연 S$15–28k (Tier 3 범위)" },
          waitlist: { en: "Direct entry", ko: "바로 입학" },
          location: { en: "Tampines / Upper Bukit Timah", ko: "Tampines · Upper Bukit Timah" } },
        { name: { en: "Singapore Korean International School (SKIS, K–12)", ko: "싱가포르한국국제학교 (SKIS, K–12)" }, stage: "pri", type: "korean", system: "korean",

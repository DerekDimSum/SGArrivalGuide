...
var CONTENT = {
  ...
  education: {
    ...
    schools: {
      ...
      intro: {
        en: "Every school named in this guide, in one filterable table. Tap filters to combine them — several can be active at once; none selected means everything shows. \"Type\" is the curriculum family: local-system schools (government MOE schools and ECDA preschools, including private chains that follow local levels) vs the international systems. Fees are researched figures or tier bands — always confirm current numbers with the school.",
        ko: "이 가이드에 등장하는 학교를 한 표에 모았어요. 필터는 여러 개를 동시에 켤 수 있고, 아무것도 선택하지 않으면 전체가 보여요. '구분'은 커리큘럼 계열이에요: 로컬 학제(정부 MOE 학교와 ECDA 유치원 — 로컬 레벨을 따르는 사립 체인 포함) vs 국제 학제들. 학비는 조사된 수치나 티어 범위예요 — 최신 금액은 반드시 학교에 확인하세요."
      },
      ...
      rows: [
        { name: "PCF Sparkletots", stage: "pre", kind: "local", tier: "anchor", feeYr: 15300,
        ...
        { name: "Skool4Kidz", stage: "pre", kind: "local", tier: "anchor", feeYr: 14100,
          fees: { en: "~S$1,175/mo (per centre)", ko: "월 약 S$1,175 (센터별 상이)" }, verify: true,
          waitlist: { en: "Popular centres 12–18 months", ko: "인기 센터 12–18개월" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } },
        { name: "My First Skool", stage: "pre", kind: "local", tier: "anchor", feeYr: 20400,
          fees: { en: "~S$1,600–1,800/mo", ko: "월 약 S$1,600–1,800" }, verify: true,
          waitlist: { en: "Popular centres 12–18 months", ko: "인기 센터 12–18개월" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } },
        { name: "MindChamps", stage: "pre", kind: "local", tier: "mid", feeYr: 22800,
          fees: { en: "~S$1,700–2,100/mo", ko: "월 약 S$1,700–2,100" },
          waitlist: { en: "Varies by centre", ko: "센터별 상이" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } },
        { name: "Pat's Schoolhouse", stage: "pre", kind: "local", tier: "mid", feeYr: 26700,
          fees: { en: "~S$1,850–2,600/mo", ko: "월 약 S$1,850–2,600" },
          waitlist: { en: "Varies by centre", ko: "센터별 상이" },
          location: { en: "Island-wide (incl. Katong)", ko: "전국 (Katong 포함)" } },
        { name: "MapleBear", stage: "pre", kind: "local", tier: "mid", feeYr: 24600,
          fees: { en: "~S$1,500–2,600/mo", ko: "월 약 S$1,500–2,600" },
          waitlist: { en: "Varies by centre", ko: "센터별 상이" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } },
        { name: "EtonHouse", stage: "pre", kind: "local", tier: "premium", feeYr: 34800,
        ...
        { name: "Odyssey", stage: "pre", kind: "local", tier: "premium", feeYr: 39300,
          fees: { en: "~S$2,650–3,900/mo", ko: "월 약 S$2,650–3,900" },
          waitlist: { en: "Varies by campus", ko: "캠퍼스별 상이" },
          location: { en: "Multiple campuses (incl. Kay Siang Rd)", ko: "여러 캠퍼스 (Kay Siang Rd 포함)" } },
        { name: "SAIS Early Learning Village", stage: "pre", kind: "american", tier: "t15", feeYr: 30820,
          fees: { en: "S$30,820/yr (pre-N/N, 2026/27)", ko: "연 S$30,820 (pre-N/N, 2026/27)" },
          waitlist: { en: "Rolling admissions", ko: "수시 입학" },
          location: "Woodleigh" },
        { name: { en: "Tanglin Trust (Early Years)", ko: "Tanglin Trust (유아부)" }, stage: "pre", kind: "british", tier: "t1", feeYr: 36300,
          fees: { en: "Nursery S$36,300/yr", ko: "Nursery 연 S$36,300" },
          waitlist: { en: "Multi-year", ko: "수년 대기" },
          location: "One-North" },
        { name: { en: "SKIS kindergarten (from age 3)", ko: "SKIS 유치부 (만 3세부터)" }, stage: "pre", kind: "korean", tier: null, feeYr: 13425,
        ...
        { name: { en: "Local MOE schools", ko: "로컬 MOE 학교" }, stage: "pri", kind: "local", tier: null, feeYr: 12420,
        ...
        { name: "Singapore American School (SAS)", stage: "pri", kind: "american", tier: "t1", feeYr: 49000,
          fees: { en: "S$38–60k/yr (Tier 1 band)", ko: "연 S$38–60k (Tier 1 범위)" },
          waitlist: { en: "Multi-year, selective", ko: "수년 대기, 선발형" },
          location: "Woodlands" },
        { name: "Tanglin Trust", stage: "pri", kind: "british", tier: "t1", feeYr: 45375,
          fees: { en: "Y1 S$45,375 (2026/27)", ko: "Y1 S$45,375 (2026/27)" },
          waitlist: { en: "Multi-year", ko: "수년 대기" },
          location: "One-North" },
        { name: { en: "UWCSEA (Dover & Tampines)", ko: "UWCSEA (Dover · Tampines)" }, stage: "pri", kind: "ib", tier: "t1", feeYr: 48606,
        ...
        { name: "Dulwich College", stage: "pri", kind: "british", tier: "t1", feeYr: 36500,
          fees: { en: "~S$35–38k/yr early years", ko: "유아부 연 약 S$35–38k" },
          waitlist: { en: "Multi-year, selective", ko: "수년 대기, 선발형" },
          location: "Bukit Batok" },
        { name: "SJII (St Joseph's Institution International)", stage: "pri", kind: "ib", tier: "t15", feeYr: 45500,
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Selective; 50% local cohort", ko: "선발형; 학생 50%가 로컬" },
          location: "Thomson" },
        { name: "NLCS Singapore", stage: "pri", kind: "british", tier: "t15", feeYr: 45500,
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Selective", ko: "선발형" },
          location: { en: "Depot Road", ko: "Depot Road" } },
        { name: "Canadian International School (CIS)", stage: "pri", kind: "ib", tier: "t15", feeYr: 45500,
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Varies; strong EAL", ko: "학교별 상이; EAL 강함" },
          location: "Lakeside" },
        { name: "Stamford American (SAIS)", stage: "pri", kind: "american", tier: "t15", feeYr: 45500,
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Rolling admissions", ko: "수시 입학" },
          location: "Woodleigh" },
        { name: "Australian International School (AIS)", stage: "pri", kind: "other", tier: "t15", feeYr: 45500,
          fees: { en: "S$35–56k/yr (Tier 1.5 band)", ko: "연 S$35–56k (Tier 1.5 범위)" },
          waitlist: { en: "Varies", ko: "학교별 상이" },
          location: "Serangoon" },
        { name: "Dover Court (Nord Anglia)", stage: "pri", kind: "british", tier: "t2", feeYr: 36500,
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate; strong EAL", ko: "보통; EAL 강함" },
          location: "Dover" },
        { name: "GESS (German European School)", stage: "pri", kind: "other", tier: "t2", feeYr: 36500,
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: { en: "Dairy Farm (Bukit Timah)", ko: "Dairy Farm (Bukit Timah)" } },
        { name: "Nexus International", stage: "pri", kind: "ib", tier: "t2", feeYr: 36500,
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate; strong EAL", ko: "보통; EAL 강함" },
          location: "Aljunied" },
        { name: "Overseas Family School (OFS)", stage: "pri", kind: "ib", tier: "t2", feeYr: 36500,
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: "Pasir Ris" },
        { name: "Chatsworth International", stage: "pri", kind: "ib", tier: "t2", feeYr: 36500,
          fees: { en: "S$28–45k/yr (Tier 2 band)", ko: "연 S$28–45k (Tier 2 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: "Bukit Timah" },
        { name: "One World International (OWIS)", stage: "pri", kind: "ib", tier: "t3", feeYr: 21500,
        ...
        { name: "Invictus International", stage: "pri", kind: "other", kindVerify: true, tier: "t3", feeYr: 21500,
          fees: { en: "S$15–28k/yr (Tier 3 band)", ko: "연 S$15–28k (Tier 3 범위)" },
          waitlist: { en: "Direct entry", ko: "바로 입학" },
          location: { en: "Multiple campuses", ko: "여러 캠퍼스" } },
        { name: "Middleton (by EtonHouse)", stage: "pri", kind: "other", kindVerify: true, tier: "t3", feeYr: 21500,
          fees: { en: "S$15–28k/yr (Tier 3 band)", ko: "연 S$15–28k (Tier 3 범위)" },
          waitlist: { en: "Direct entry", ko: "바로 입학" },
          location: { en: "Tampines / Upper Bukit Timah", ko: "Tampines · Upper Bukit Timah" } },
        { name: { en: "Singapore Korean International School (SKIS, K–12)", ko: "싱가포르한국국제학교 (SKIS, K–12)" }, stage: "pri", kind: "korean", tier: null, feeYr: 13425,

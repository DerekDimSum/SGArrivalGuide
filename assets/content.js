  ...
  nav: [
    { id: "education", label: { en: "Education", ko: "교육" },
      ...
      subs: [
        ...
        { id: "schools", label: { en: "School list", ko: "학교 목록" } },
  ...
  education: {
    ...
    overview: {
      ...
      links: [
        ...
        { href: "#schools", label: { en: "School list", ko: "학교 목록" }, desc: { en: "All 30 schools in one sortable, filterable table — with what makes each one distinctive.", ko: "30개 학교를 한 표에 — 정렬·필터 가능, 학교별 특징까지." } },
    ...
    directoryLink: { en: "Open the full school list →", ko: "전체 학교 목록 열기 →" },
    ...
    schools: {
      ...
      rows: [
        { name: "PCF Sparkletots", stage: "pre", kind: "local", tier: "anchor", feeYr: 15300, site: "https://pcfsparkletots.org.sg",
          ...
          about: { en: "Singapore's largest preschool operator (PAP Community Foundation) — hundreds of centres in HDB void decks; local curriculum, bilingual English + Mother Tongue.", ko: "싱가포르 최대 유치원 운영사(PAP Community Foundation) — HDB 1층 보이드덱에 수백 개 센터, 로컬 커리큘럼에 영어+모국어 이중언어." } },
        { name: "Skool4Kidz", stage: "pre", kind: "local", tier: "anchor", feeYr: 14100, site: "https://www.skool4kidz.com.sg",
          ...
          waitlist: { en: "Popular centres 12–18 months", ko: "인기 센터 12–18개월" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } ,
          about: { en: "Anchor operator run by Kinderland's parent group; big new-town campuses (Punggol, Sengkang) with sports and outdoor play emphasis.", ko: "Kinderland 계열 앵커 오퍼레이터 — 신도시(Punggol, Sengkang)의 대형 캠퍼스, 스포츠·야외 놀이 강조." } },
        { name: "My First Skool", stage: "pre", kind: "local", tier: "anchor", feeYr: 20400, site: "https://www.myfirstskool.com",
          ...
          waitlist: { en: "Popular centres 12–18 months", ko: "인기 센터 12–18개월" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } ,
          about: { en: "NTUC First Campus's anchor brand — the other giant of heartland childcare; strong on affordability and long full-day hours for working parents.", ko: "NTUC First Campus의 앵커 브랜드 — 헤어틀랜드 보육의 또 다른 거인. 저렴한 학비와 긴 종일반이 강점." } },
        { name: "MindChamps", stage: "pre", kind: "local", tier: "mid", feeYr: 22800, site: "https://www.mindchamps.org",
          ...
          location: { en: "Island-wide", ko: "전국 캠퍼스" } ,
          about: { en: "Premium-marketed local chain built around its \"3-Mind\" method (champion / learning / creative); strong on phonics and reading, expensive for a local operator.", ko: "'3-Mind' 교수법(챔피언·학습·창의)을 앞세운 프리미엄 로컬 체인 — 파닉스·읽기 강세, 로컬 오퍼레이터치곤 학비가 높은 편." } },
        { name: "Pat's Schoolhouse", stage: "pre", kind: "local", tier: "mid", feeYr: 26700, site: "https://www.patsschoolhouse.com",
          ...
          about: { en: "Long-running Singapore brand known for bilingual immersion (English–Mandarin) and its arts/music-heavy programme; well-loved by local professional families.", ko: "영어–중국어 이중언어 몰입과 예술·음악 중심 프로그램으로 유명한 싱가포르 장수 브랜드 — 로컬 전문직 가정에 인기." } },
        { name: "MapleBear", stage: "pre", kind: "local", tier: "mid", feeYr: 24600, site: "https://maplebear.sg",
          ...
          waitlist: { en: "Varies by centre", ko: "센터별 상이" },
          location: { en: "Island-wide", ko: "전국 캠퍼스" } ,
          about: { en: "Canadian-curriculum franchise: play-based bilingual immersion, many centres in condos and business parks; a mid-priced middle ground between local and international.", ko: "캐나다 커리큘럼 프랜차이즈: 놀이 기반 이중언어 몰입, 콘도·비즈니스파크 내 센터 다수 — 로컬과 국제 사이의 중가 선택지." } },
        { name: "EtonHouse", stage: "pre", kind: "local", tier: "premium", feeYr: 34800, site: "https://www.etonhouse.edu.sg",
          ...
          about: { en: "Singapore-founded international preschool group (Reggio Emilia-inspired inquiry learning); the Newton flagship feeds into EtonHouse/Middleton primary paths.", ko: "싱가포르 태생 국제 유치원 그룹(레지오 에밀리아식 탐구 학습) — Newton 플래그십은 EtonHouse·Middleton 초등 과정으로 이어짐." } },
        { name: "Odyssey", stage: "pre", kind: "local", tier: "premium", feeYr: 39300, site: "https://www.odysseytheglobalpreschool.com",
          ...
          about: { en: "Boutique premium preschool (Busy Bees group) with small class sizes and a strong inquiry/Reggio approach; Fourth Avenue and Wilkinson campuses.", ko: "소규모 학급과 탐구·레지오 접근이 강한 부티크 프리미엄 유치원(Busy Bees 그룹) — Fourth Avenue·Wilkinson 캠퍼스." } },
        { name: "SAIS Early Learning Village", stage: "pre", kind: "american", tier: "t15", feeYr: 30820, site: "https://www.sais.edu.sg",
          ...
          location: "Woodleigh" ,
          about: { en: "Purpose-built early-years campus (ages 2–6) shared with Australian International School — a natural on-ramp into SAIS primary; rolling entry.", ko: "Australian International School과 함께 쓰는 2–6세 전용 유아 캠퍼스 — SAIS 초등으로 자연스럽게 이어지는 관문, 수시 입학." } },
        { name: { en: "Tanglin Trust (Early Years)", ko: "Tanglin Trust (유아부)" }, stage: "pre", kind: "british", tier: "t1", feeYr: 36300, site: "https://www.tts.edu.sg",
          ...
          location: "One-North" ,
          about: { en: "The British flagship's Nursery/Reception; getting in early is the usual route into a school with a multi-year waitlist further up.", ko: "영국식 플래그십의 Nursery·Reception — 상급 학년은 수년 대기이므로 이 단계에서 일찍 들어가는 게 통상적인 루트." } },
        { name: { en: "SKIS kindergarten (from age 3)", ko: "SKIS 유치부 (만 3세부터)" }, stage: "pre", kind: "korean", tier: null, feeYr: 13425, site: "https://www.skis.kr",
          ...
          about: { en: "Korean-curriculum kindergarten inside the Korean school campus (Bukit Timah) — Korean-language immersion with English, the smoothest continuity for a later return to Korea.", ko: "한국학교 캠퍼스(부킷 티마) 안의 한국 교육과정 유치부 — 한국어 몰입에 영어 병행, 훗날 귀국 시 가장 매끄러운 연속성." } },
        { name: { en: "Local MOE schools", ko: "로컬 MOE 학교" }, stage: "pri", kind: "local", tier: null, feeYr: 12420, site: "https://www.moe.gov.sg",
          ...
          about: { en: "Government primary/secondary — rigorous, English-medium with compulsory Mother Tongue; foreigners are placed only after citizens and PRs, via the AEIS entrance test.", ko: "정부 초·중등 — 엄격한 영어 수업에 모국어 필수. 외국인은 시민권자·영주권자 배정 후 AEIS 입학시험을 거쳐 배정." } },
        { name: "Singapore American School (SAS)", stage: "pri", kind: "american", tier: "t1", feeYr: 49000, site: "https://www.sas.edu.sg",
          ...
          location: "Woodlands" ,
          about: { en: "The largest single-campus American school abroad (Woodlands): US curriculum with AP, huge facilities and athletics, and a distinct American expat community around it.", ko: "해외 최대 단일 캠퍼스 미국학교(Woodlands): AP 포함 미국 교육과정, 대규모 시설과 스포츠, 주변에 형성된 뚜렷한 미국계 커뮤니티." } },
        { name: "Tanglin Trust", stage: "pri", kind: "british", tier: "t1", feeYr: 45375, site: "https://www.tts.edu.sg",
          ...
          waitlist: { en: "Multi-year", ko: "수년 대기" },
          location: "One-North" ,
          about: { en: "Singapore's oldest British international school (1925), a non-profit; English National Curriculum through to a choice of A-Levels or IB Diploma at Sixth Form.", ko: "싱가포르 최고(最古)의 영국계 국제학교(1925), 비영리 — 영국 국가 교육과정 후 식스폼에서 A-Level 또는 IB 디플로마 선택." } },
        { name: { en: "UWCSEA (Dover & Tampines)", ko: "UWCSEA (Dover · Tampines)" }, stage: "pri", kind: "ib", tier: "t1", feeYr: 48606, site: "https://www.uwcsea.edu.sg",
          ...
          about: { en: "Part of the global United World Colleges movement — IB throughout, a defining service-learning and outdoor-education ethos, and boarding for older students; famously oversubscribed.", ko: "글로벌 United World Colleges 운동의 일원 — 전 과정 IB, 봉사학습·야외교육이 학교의 정체성, 고학년 기숙사 운영. 경쟁률이 매우 높기로 유명." } },
        { name: "Dulwich College", stage: "pri", kind: "british", tier: "t1", feeYr: 36500, site: "https://singapore.dulwich.org",
          ...
          about: { en: "Sister school of London's Dulwich College — English curriculum with IGCSE then IB, strong music and drama, purpose-built Bukit Batok campus.", ko: "런던 Dulwich College의 자매 학교 — 영국 교육과정(IGCSE 후 IB), 음악·연극 강세, Bukit Batok의 전용 캠퍼스." } },
        { name: "SJII (St Joseph's Institution International)", stage: "pri", kind: "ib", tier: "t15", feeYr: 45500, site: "https://www.sji-international.com.sg",
          ...
          location: "Thomson" ,
          about: { en: "Catholic, Lasallian-ethos school affiliated with SJI: IB throughout, roughly half the cohort Singaporean, and — unusually — Singapore citizens may enrol at secondary level (elementary is for foreign passports).", ko: "SJI 계열의 가톨릭·라살 정신 학교: 전 과정 IB, 학생 약 절반이 싱가포르인 — 특이하게 중등부는 싱가포르 시민도 입학 가능(초등부는 외국 여권 대상)." } },
        { name: "NLCS Singapore", stage: "pri", kind: "british", tier: "t15", feeYr: 45500, site: "https://www.nlcssingapore.sg",
          ...
          about: { en: "Sister school of North London Collegiate — academically selective, English curriculum to IB, and a smaller, more academically intense feel than the flagships.", ko: "North London Collegiate의 자매 학교 — 학업 선발형, 영국 과정에서 IB로 이어지며 플래그십보다 규모가 작고 학업 강도가 높은 분위기." } },
        { name: "Canadian International School (CIS)", stage: "pri", kind: "ib", tier: "t15", feeYr: 45500, site: "https://www.cis.edu.sg",
          ...
          location: "Lakeside" ,
          about: { en: "Ontario-aligned IB school best known for its Chinese–English bilingual programme (50/50 instruction from kindergarten); Lakeside main campus plus a Tanjong Katong site.", ko: "온타리오 기반 IB 학교로 중국어–영어 이중언어 프로그램(유치부부터 50/50 수업)이 특히 유명 — Lakeside 본교와 Tanjong Katong 캠퍼스." } },
        { name: "Stamford American (SAIS)", stage: "pri", kind: "american", tier: "t15", feeYr: 45500, site: "https://www.sais.edu.sg",
          fees: { en: "S$35–56k/yr (premium band)", ko: "연 S$35–56k (프리미엄 범위)" },
          waitlist: { en: "Rolling admissions", ko: "수시 입학" },
          location: "Woodleigh" ,
          about: { en: "Cognita-owned American school offering both IB and AP; rolling admissions, generous EAL, and the Woodleigh MRT-side campus that anchors that district's expat pocket.", ko: "Cognita 소유 미국계 학교로 IB와 AP를 모두 제공 — 수시 입학, 넉넉한 EAL 지원, Woodleigh역 옆 캠퍼스가 그 동네 외국인 포켓의 중심." } },
        { name: "Australian International School (AIS)", stage: "pri", kind: "other", tier: "t15", feeYr: 45500, site: "https://www.ais.com.sg",
          ...
          location: "Serangoon" ,
          about: { en: "Australian curriculum (Australian year structure, HSC or IB Diploma) — southern-hemisphere calendar starts in January, which matters for children arriving mid-year.", ko: "호주 교육과정(호주식 학년 구조, HSC 또는 IB 디플로마) — 남반구 학사력이라 1월 학기 시작, 연중 도착하는 아이에게 중요한 포인트." } },
        { name: "Dover Court (Nord Anglia)", stage: "pri", kind: "british", tier: "t2", feeYr: 36500, site: "https://www.nordangliaeducation.com/dover-court-singapore",
          ...
          location: "Dover" ,
          about: { en: "Nord Anglia school with a long-standing inclusion programme (one of the few with dedicated learning-support pathways) and one of the strongest EAL set-ups for newcomers.", ko: "Nord Anglia 계열, 오랜 통합교육 프로그램(전용 학습지원 과정을 갖춘 몇 안 되는 학교)과 신규 입국자에게 가장 든든한 EAL 체계." } },
        { name: "GESS (German European School)", stage: "pri", kind: "other", tier: "t2", feeYr: 36500, site: "https://www.gess.sg",
          ...
          about: { en: "Two schools in one: a German-curriculum section (Abitur) and an English IB section — European community feel, Dairy Farm campus beside the nature park.", ko: "한 학교 안에 두 과정: 독일 교육과정(아비투어) 섹션과 영어 IB 섹션 — 유럽계 커뮤니티 분위기, 자연공원 옆 Dairy Farm 캠퍼스." } },
        { name: "Nexus International", stage: "pri", kind: "ib", tier: "t2", feeYr: 36500, site: "https://www.nexus.edu.sg",
          fees: { en: "S$28–45k/yr (established band)", ko: "연 S$28–45k (안정형 범위)" },
          waitlist: { en: "Moderate; strong EAL", ko: "보통; EAL 강함" },
          location: "Aljunied" ,
          about: { en: "Taylor's-group IB school in a purpose-built Aljunied campus (2020); known for flexible, tech-forward learning and a welcoming EAL route.", ko: "Taylor's 그룹의 IB 학교, Aljunied의 신축 전용 캠퍼스(2020) — 유연하고 테크 친화적인 학습, 신입생에게 우호적인 EAL 루트." } },
        { name: "Overseas Family School (OFS)", stage: "pri", kind: "ib", tier: "t2", feeYr: 36500, site: "https://www.ofs.edu.sg",
          fees: { en: "S$28–45k/yr (established band)", ko: "연 S$28–45k (안정형 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: "Pasir Ris" ,
          about: { en: "One of the most internationally mixed student bodies in Singapore (70+ nationalities), IB throughout, large Pasir Ris campus; a practical, low-drama landing school.", ko: "싱가포르에서 가장 다국적인 학생 구성(70여 개국), 전 과정 IB, Pasir Ris의 대형 캠퍼스 — 실용적이고 부담 없는 첫 정착 학교." } },
        { name: "Chatsworth International", stage: "pri", kind: "ib", tier: "t2", feeYr: 36500, site: "https://www.chatsworth.com.sg",
          fees: { en: "S$28–45k/yr (established band)", ko: "연 S$28–45k (안정형 범위)" },
          waitlist: { en: "Moderate", ko: "보통" },
          location: "Bukit Timah" ,
          about: { en: "Small, family-feel IB school (Bukit Timah) — modest class sizes and a less pressured atmosphere than the flagships.", ko: "소규모 가족적 분위기의 IB 학교(Bukit Timah) — 작은 학급, 플래그십보다 압박이 덜한 환경." } },
        { name: "One World International (OWIS)", stage: "pri", kind: "ib", tier: "t3", feeYr: 21500, site: "https://owis.org",
          ...
          about: { en: "Value-priced IB school with nationality caps to keep the mix diverse; campuses at Nanyang (Jurong) and Mountbatten.", ko: "다양성 유지를 위해 국적별 정원을 두는 실속형 IB 학교 — Nanyang(Jurong)·Mountbatten 캠퍼스." } },
        { name: "Invictus International", stage: "pri", kind: "other", kindVerify: true, tier: "t3", feeYr: 21500, site: "https://invictus.edu.sg",
          ...
          about: { en: "Budget-tier international school (Cambridge/IB), several small campuses; direct entry, popular as an affordable first year while waitlists elsewhere clear.", ko: "가성비 국제학교(케임브리지/IB), 소규모 캠퍼스 여럿 — 즉시 입학 가능, 다른 학교 대기 중 첫해를 저렴하게 보내는 용도로 인기." } },
        { name: "Middleton (by EtonHouse)", stage: "pri", kind: "other", kindVerify: true, tier: "t3", feeYr: 21500, site: "https://www.middleton.edu.sg",
          ...
          about: { en: "EtonHouse's value-focused primary/secondary brand (Cambridge curriculum) — continuity for EtonHouse preschoolers, campuses in Tampines and Upper Bukit Timah.", ko: "EtonHouse의 실속형 초·중등 브랜드(케임브리지 과정) — EtonHouse 유치원생의 연속 진학, Tampines·Upper Bukit Timah 캠퍼스." } },
        { name: { en: "Singapore Korean International School (SKIS, K–12)", ko: "싱가포르한국국제학교 (SKIS, K–12)" }, stage: "pri", kind: "korean", tier: null, feeYr: 13425, site: "https://www.skis.kr",
          ...
          location: { en: "Upper Bukit Timah", ko: "Upper Bukit Timah" },
          about: { en: "The Korean Ministry of Education-accredited K–12 (Bukit Timah): Korean national curriculum with strong English, credits transfer home cleanly — the anchor of the Korean family cluster.", ko: "한국 교육부 인가 K–12(부킷 티마): 한국 교육과정에 영어를 강화, 귀국 시 학력 인정이 매끄러움 — 한인 가족 클러스터의 앵커." } }
      ]
    },
